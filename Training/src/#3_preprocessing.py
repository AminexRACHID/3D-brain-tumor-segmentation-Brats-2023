...
IN_TRAIN_NNUNET_IMAGES = '../data/training/SAD_Unet_raw/Dataset001_BRATS/imagesTr/'
IN_TRAIN_NNUNET_LABELS = '../data/training/SAD_Unet_raw/Dataset001_BRATS/labelsTr/'
IN_TEST_NNUNET_IMAGES = '../data/test/SAD_Unet_raw/imagesTs/'
IN_TEST_NNUNET_LABELS = '../data/test/SAD_Unet_raw/labelsTs/'
...
def nnunet_to_npy(IN_IMAGES, IN_LABELS, OUT_IMAGES, OUT_LABELS):
    ...
    t1n_list = sorted(glob.glob(IN_IMAGES+'/*0000.nii'))
    t1c_list = sorted(glob.glob(IN_IMAGES+'/*0001.nii'))
    t2w_list = sorted(glob.glob(IN_IMAGES+'/*0002.nii'))
    t2f_list = sorted(glob.glob(IN_IMAGES+'/*0003.nii'))
    mask_list = sorted(glob.glob(IN_LABELS+'/*.nii'))
